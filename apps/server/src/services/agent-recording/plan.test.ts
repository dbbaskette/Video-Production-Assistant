...
describe('deriveAgentRecordingPlan', () => {
  it('turns a shot plan into ordered capture actions without enabling audio or camera', () => {
    const project: Project = { id: '11111111-1111-4111-8111-111111111111', name: 'demo', path: '/tmp/demo', created: '2026-07-31T12:00:00.000Z', objective: 'Show the workflow', brand: null };
