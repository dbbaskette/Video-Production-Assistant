import { splitScriptIntoChunks, type ScriptChunk } from '@vpa/shared';
export { splitIntoParagraphs, splitDialogIntoChunks, splitScriptIntoChunks, type ScriptChunk } from '@vpa/shared';
